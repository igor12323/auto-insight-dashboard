    ...
    >
      <div className="bg-black bg-opacity-60 p-6 rounded-lg">
        ...
        <section className="bg-gray-100 bg-opacity-60 p-4 rounded-lg shadow-lg mb-6">
          ...
          {/* Eksport CSV dla wybranej marki */}
          {selectedBrand && (
        ...
        <section className="bg-white bg-opacity-60 p-4 rounded-lg shadow-lg mb-6">
          ...
          <div className="mt-6">
            <label htmlFor="model1" className="mr-2">
              Select Model 1:
            </label>
            <select
              id="model1"
              className="p-2 border border-gray-300"
              onChange={(e) => setSelectedModel1(Number(e.target.value))}
            >
              <option value="">--Select--</option>
          ...
          <div className="mt-4">
            <label htmlFor="model2" className="mr-2">
              Select Model 2:
            </label>
            <select
              id="model2"
              className="p-2 border border-gray-300"
              onChange={(e) => setSelectedModel2(Number(e.target.value))}
            >
              <option value="">--Select--</option>
              {carData.map((car, index) => (
                <option key={car.id} value={index}>
          ...
          {selectedModel1 !== null && selectedModel2 !== null && (
        ...
        <section className="bg-gray-200 bg-opacity-60 p-4 rounded-lg shadow-lg mb-6">
          ...
          {/* Lista rozwijana do wyboru segmentu */}
          <div className="mt-6">
            <label htmlFor="segment" className="mr-2">
              Select Segment:
            </label>
            <select
              id="segment"
